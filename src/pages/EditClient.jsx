...
import { ArrowLeft, Save, Users, Trash2, AlertCircle } from "lucide-react";
...
export default function EditClient() {
  ...
  const handleDelete = async () => {
    if (!window.confirm(`Are you sure you want to delete ${clientData.name}? This action cannot be undone.`)) {
      return;
    }
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mt-2">Update client information for {clientData.name}</p>
          </div>
        </motion.div>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="total_revenue" className="text-sm font-medium text-gray-700">
                        Total Revenue
                      </Label>
                      <Input
                        id="total_revenue"
                        ...
                        step="0.01"
                        min="0"
                        value={clientData.total_revenue || 0}
                        onChange={(e) => updateField("total_revenue", parseFloat(e.target.value) || 0)}
                        className="rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-400"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="total_events" className="text-sm font-medium text-gray-700">
                        Total Events
                      </Label>
                      <Input
                        id="total_events"
                        type="number"
                        min="0"
                        value={clientData.total_events || 0}
                        onChange={(e) => updateField("total_events", parseInt(e.target.value) || 0)}
                        className="rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-400"
                      />
                    </div>
                  </div>
