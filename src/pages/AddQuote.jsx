...
import { ArrowLeft, Save, DollarSign, Upload, Loader2 } from "lucide-react";
...
export default function AddQuote() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Quote.create(dataToSubmit);
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mt-2">Create a new quote or upload existing PDF</p>
          </div>
        </motion.div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                      {isProcessingPDF ? "Processing PDF..." : "Upload Quote PDF"}
                    </h3>
                    <p className="text-gray-500 mb-4">
                      {isProcessingPDF 
                        ? "Extracting data from your PDF document..." 
                        : "Upload a PDF quote to automatically extract information"
                      }
                    </p>
